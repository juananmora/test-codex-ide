...
const AboutSection = () => (
  <Section title="About" className="pb-0" center maxWidthClass="max-w-4xl">
    <div className="mx-auto max-w-3xl text-center section-copy">
      ...
      <p className="mt-4 max-w-3xl">
        We&rsquo;re committed to helping maintain and evolve this as an open
        format that benefits the entire developer community, regardless of
